...
\begin{figure}[!hb]
    ...
    \caption{Model of Two Operators Watching a Single Resource's State}
    \label{problem-model}
\end{figure}
...
\begin{figure}[!hb]
    ...
    \caption{Model of Moodle, Tutors, and MySQL Industry Example}
    \label{moodle-tutors}
\end{figure}
...
\bibitem[Operator Pattern, 2022]{operator-pattern}(accessed Nov. 03, 2022).
